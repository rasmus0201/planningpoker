...
<head>
    ...
    <link rel="mask-icon" href="/safari-pinned-tab.svg" color="#9a7143">
    <meta name="apple-mobile-web-app-title" content="Planningpoker">
    ...
    <meta name="apple-mobile-web-app-title" content="Planningpoker">
    <link rel="apple-touch-startup-image" href="/splash/apple_splash_640x1136.png" media="(device-width: 320px) and (device-height: 568px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)">
    <link rel="apple-touch-startup-image" href="/splash/apple_splash_750x1334.png" media="(device-width: 375px) and (device-height: 667px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)">
    <link rel="apple-touch-startup-image" href="/splash/apple_splash_1242x2208.png" media="(device-width: 414px) and (device-height: 736px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)">
    <link rel="apple-touch-startup-image" href="/splash/apple_splash_1125x2436.png" media="(device-width: 375px) and (device-height: 812px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)">
    <link rel="apple-touch-startup-image" href="/splash/apple_splash_1536x2048.png" media="(min-device-width: 768px) and (max-device-width: 1024px) and (-webkit-min-device-pixel-ratio: 2) and (orientation: portrait)">
    <link rel="apple-touch-startup-image" href="/splash/apple_splash_1668x2224.png" media="(min-device-width: 834px) and (max-device-width: 834px) and (-webkit-min-device-pixel-ratio: 2) and (orientation: portrait)">
    <link rel="apple-touch-startup-image" href="/splash/apple_splash_2048x2732.png" media="(min-device-width: 1024px) and (max-device-width: 1024px) and (-webkit-min-device-pixel-ratio: 2) and (orientation: portrait)">
...
<body>
    <div id="app" class="container-fluid" :class="game.state" v-cloak>
        ...
        <template v-if="session.auth === false">
            ...
            <div v-else-if="game.state === game.states.LOBBY || connection" class="lobby content-container">
                <div class="d-flex">
        ...
        <template v-if="session.auth">
            ...
            <div v-else-if="game.state === game.states.LOBBY" class="lobby content-container">
            ...
            <div v-else-if="game.state === game.states.FINISHED" class="content-container">
